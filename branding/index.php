...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/extensions/header-preload.php"; ?>
    ...
    <title>Charte graphique | Ressources | Minteck Projects™</title>
...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/extensions/menu.php"; ?>
    ...
    <h1 class="high">Charte graphique<span class="tseparator"> </span><a class="editLink" href="/tools/editBranding">modifier</a></h1>
