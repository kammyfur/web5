...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/extensions/header-preload.php"; ?>
    ...
    <title>Droits d'auteurs | Ressources | Minteck Projects™</title>
...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/extensions/menu.php"; ?>
    ...
    <h1 class="high">Informations sur les droits d'auteurs<span class="tseparator"> </span><a class="editLink" href="/tools/editCopyright">modifier</a></h1>
    <?= file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/copyright/markup.xhtml") ?>
