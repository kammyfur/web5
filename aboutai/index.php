...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/extensions/header-preload.php"; ?>
    ...
    <title>Intelligence artificielle | Minteck Projects™</title>
...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . "/extensions/menu.php"; ?>
    ...
    <h1 class="high">Minteck Projects et l'intelligence artificielle<span class="tseparator"> </span><a class="editLink" href="/tools/editAboutAi">modifier</a></h1>
    <?= file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/aboutai/markup.xhtml") ?>
